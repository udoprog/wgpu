...
use crate::id::{Id, Marker, RawId};
use crate::{Epoch, FastHashMap, Index};
use std::fmt::Debug;
...
impl IdentityHandlerFactory for IdentityManagerFactory {
    type Input = ();
    ...
    fn input_to_id(_id_in: Self::Input) -> RawId {
...
fn test_epoch_end_of_life() {
    let man = IdentityManager::new();
    let forced_id = man.mark_as_used(crate::id::BufferId::zip(0, 1, Backend::Empty));
